        ...
        <main className="sm:flex">
          ...
          <div className="sm:ml-6">
            ...
            <div className="mt-10 flex space-x-3 sm:border-l sm:border-transparent sm:pl-6">
              ...
              <Link href="/company">
                <a className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-orange-700 bg-orange-100 hover:bg-orange-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
                  Contact support
                </a>
              </Link>
            </div>
