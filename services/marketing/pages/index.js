            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8 xl:grid xl:grid-cols-2 xl:grid-flow-col-dense xl:gap-x-8">
              <div className="relative pt-24 pb-24 xl:col-start-1 xl:pb-24">
                ...
                <p className="mt-5 text-lg text-trueGray-500">
                  Learn your conversion and churn rates from different countries and audiences to
                  get actionable data best fits your business. Analyze your revenue flow from
                  various filters and better understand anomalies and act upon them.
                </p>
                <div className="mt-12 grid grid-cols-1 gap-y-12 gap-x-6 sm:grid-cols-2">
                  ...
                  <p>
                    ...
                    <span className="mt-1 block text-base text-trueGray-500">
                      <span className="font-semibold">Transactions</span> were stored and analyzed
                      on Socketkit.
                    </span>
                  </p>
                  <p>
