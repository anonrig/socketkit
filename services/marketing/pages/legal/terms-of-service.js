        ...
        <div className="relative px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 prose prose-orange prose-lg text-warmGray-500 mx-auto">
            ...
            <p>
              ...
              continue to use Socketkit if you do not agree to take all of the terms and conditions
              stated on this page.
            </p>
            ...
            <p>
              Unless otherwise stated, Socketkit, Inc. and/or its licensors own the intellectual
              property rights for all material on Socketkit. All intellectual property rights are
              reserved. You may access this from Socketkit for your own personal use subjected to
              restrictions set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
              <li>Republish material from Socketkit</li>
              <li>Sell, rent or sub-license material from Socketkit</li>
              <li>Reproduce, duplicate or copy material from Socketkit</li>
              <li>Redistribute content from Socketkit</li>
            </ul>

            <p>
              Parts of this website offer an opportunity for users to post and exchange opinions and
              information in certain areas of the website. Socketkit, Inc. does not filter, edit,
              publish or review Comments prior to their presence on the website. Comments do not
              reflect the views and opinions of Socketkit, Inc.,its agents and/or affiliates.
              Comments reflect the views and opinions of the person who post their views and
              opinions. To the extent permitted by applicable laws, Socketkit, Inc. shall not be
            ...
            <p>
              Socketkit, Inc. reserves the right to monitor all Comments and to remove any Comments
            ...
            <p>
              You hereby grant Socketkit, Inc. a non-exclusive license to use, reproduce, edit and
            ...
            <p>
              ...
              from the visibility of the hyperlink compensates the absence of Socketkit, Inc.; and
            ...
            <p>
              ...
              linking to our website, you must inform us by sending an e-mail to Socketkit, Inc..
              Please include your name, your organization name, contact information as well as the
              URL of your site, a list of any URLs from which you intend to link to our Website, and
