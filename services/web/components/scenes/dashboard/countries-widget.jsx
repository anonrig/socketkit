    ...
    <section className="lg:col-span-4">
      <dl className="grid grid-cols-1 md:grid-cols-4 lg:space-x-6 bg-white shadow-lgs rounded-md">
        <div className="col-span-2 flex flex-1 flex-col justify-center items-left rounded-md overflow-hidden h-80">
          <h3 className="font-bold text-stone-900 sm:tracking-tight text-2xl py-3.5 px-4 sm:px-6 z-10">
            Countries
          </h3>
                  ...
                  <table className="min-w-full">
                    ...
                    <tbody className="bg-white">
                      {data?.slice(0, 5).map((c) => (
                        <tr key={c.country_id}>
                          <td className="pr-6 py-4 whitespace-nowrap text-sm font-medium text-stone-900">
                            {c.country_name}
                          </td>
